...
class CiceroRestABC(object):
    ...
    compose_request_url() and submit_request() methods defined here to perform
    the mechanics of composing a Cicero API url, requesting it, and receiving
    a JSON response.
    """
    
    def compose_request_url(self, ENDPOINT, kwargs):
        """
        # compose_request_url()
    ...
    def submit_request(self, request_url):
        """
        # submit_request()
        
        Given a request_url composed with the compose_request_url() method, this
...
class CiceroRestConnection(CiceroRestABC):
    ...
    def get_election_event(self, **kwargs):
        ...
        election_event_request_url = self.compose_request_url(ELECTION_EVENT_ENDPOINT, kwargs)
        
        election_event_response = self.submit_request(election_event_request_url)
    ...
    def get_official(self, **kwargs):
        ...
        official_request_url = self.compose_request_url(OFFICIAL_ENDPOINT, kwargs)
        
        official_response = self.submit_request(official_request_url)
    ...
    def get_legislative_district(self, **kwargs):
        ...
        leg_district_request_url = self.compose_request_url(LEGISLATIVE_DISTRICT_ENDPOINT, kwargs)
            
        leg_district_response = self.submit_request(leg_district_request_url)
    ...
    def get_nonlegislative_district(self, **kwargs):
        ...
        nonleg_request_url = self.compose_request_url(NONLEGISLATIVE_DISTRICT_ENDPOINT, kwargs)
            
        nonleg_request_response = self.submit_request(nonleg_request_url)
    ...
    def get_map(self, **kwargs):
        ...
        map_request_url = self.compose_request_url(MAP_ENDPOINT, kwargs)
        
        map_request_response = self.submit_request(map_request_url)
    ...
    def get_district_type(self):
        ...
        district_type_response = self.submit_request(district_type_request_url)
    ...
    def get_account_credits_remaining(self):
        ...
        credits_remaining_response = self.submit_request(credits_remaining_request_url)
    ...
    def get_account_usage(self, first_time, second_time=""):
        ...
        account_usage_response = self.submit_request(account_usage_request_url)
    ...
    def get_version(self):
        ...
        version_response = self.submit_request(version_request_url)
